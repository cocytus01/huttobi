     ...
     for (var i = 0; i < 8; i++) {
      ...
      break;
        ...
        case SpriteTag.goal :
          ...
          break;
        case SpriteTag.teki :
            this.sprite = cc.Sprite.create('#object7');
              console.log("#object7");
          break;
        defalut :
        this.sprite = cc.Sprite.create('#object0');
